...
Below are first few rows of the two data sets before they are merged in Spark.
...
Below is the first few rows of the merged dataset in Spark that includes only seven countries. 
